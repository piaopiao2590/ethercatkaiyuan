...
------
-----------------------------------------------------------------------------------------*/
#define RxTxSpiData         ethercat_data_rw
...
#define EscIsr              EXTI9_5_IRQHandler
...
#define ACK_SYNC0_INT      EXTI_ClearITPendingBit(EXTI_Line0)
...
#define ethercat_timer_isr TIM1_UP_TIM10_IRQHandler
#define ACK_TIMER_INT      TIM_ClearITPendingBit(TIM1 , TIM_FLAG_Update)
/*-----------------------------------------------------------------------------------------
------
------    Configuration Bits
------
